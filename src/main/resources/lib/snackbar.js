...
(function() {
  ...
  MaterialSnackbar.prototype.removeSnackbar_ = function() {
    ...
    if (this.textElement_.parentNode) this.textElement_.parentNode.removeChild(this.textElement_);
    if (this.snackbarElement_.parentNode) this.snackbarElement_.parentNode.removeChild(this.snackbarElement_);
  };
